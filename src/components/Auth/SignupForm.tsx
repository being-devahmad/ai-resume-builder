                ...
                <div className="space-y-4">
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormControl>
                                            <div className="relative">
                                                <div className="absolute left-3 top-1/2 -translate-y-1/2">
                                                    <User className="h-5 w-5 text-[#30D0AD]" />
                                                </div>
                                                <Input
                                                    {...field}
                                                    type="text"
                                    ...
                                    <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                                        <FormControl>
                                            <Checkbox
                                                ...
                                                className="border-[#30D0AD] data-[state=checked]:bg-[#30D0AD] data-[state=checked]:border-[#30D0AD]"
                                            />
                                        </FormControl>
                                        <div className="space-y-1 leading-none">
                                            <FormLabel>
                                                I agree to all statements include in{" "}
                                                <RouterLink to="/terms" className="text-[#30D0AD] hover:text-emerald-500">
                                                    Terms of Use
                                                </RouterLink>
                                            </FormLabel>
                                        </div>
                    ...
                    <div className="space-y-2 text-sm text-center">
                        <p className="">
                            ...
                            <RouterLink to="/login" className="text-[#30D0AD] hover:text-emerald-500 text-sm font-bold">
                                Signin
                            </RouterLink>
                        </p>
                    </div>
